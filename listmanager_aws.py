...
class ListManager(PyQt5.QtWidgets.QMainWindow):
    ...
    def showversions(self):
        ...
        xapian_version = xapian.version_string() if xapian else ' '
        
        values = (python_version, QtCore.PYQT_VERSION_STR, QtCore.QT_VERSION_STR, sip.SIP_VERSION_STR, sqla_version, xapian_version)
        text = "python:\t{}\npyqt:\t{}\nqt:\t{}\nsip:\t{}\nsqlalchemy:\t{}\nxapian:\t{}".format(*values)
